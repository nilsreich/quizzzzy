...
export const Game = ({ setData, data }: Props) => {
  ...
  return (
    <div className="flex flex-col mx-auto gap-4 p-4 w-[800px]">
      <div className="border-b w-full border-neutral-800 flex justify-between items-center pb-4">
        <div>{data.points}</div>
        <div>
      ...
      <div className="border p-4 rounded flex justify-center items-center text-4xl grow border-neutral-800">
        {question}
      </div>
          ...
          <button
            ...
            className={`${
              userAnswer === index
                ...
                ? "ring ring-green-600"
                : "ring-0"
            } border rounded p-2 border-neutral-800 min-h-[100%] overflow-clip text-lg disabled:text-neutral-500`}
          >
            {option}
          </button>
        ))}
      ...
      {resultColor ? (
        <button
          onClick={handleNext}
          className="bg-neutral-300 text-neutral-800 rounded py-4 font-medium"
        >
        ...
        <button
          ...
          className="bg-neutral-300 text-neutral-800 rounded py-4 font-medium disabled:bg-neutral-500"
        >
          Check
        </button>
      )}
